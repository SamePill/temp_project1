<template>
  ...
  >
    ...
    <!-- 수정하기 -->
    <div @click="$emit('popBtn1',props.profile.engrId)" class="cursor-pointer flex justify-center items-center flex-grow-0 flex-shrink-0 gap-5" v-show="props.mode == '20'">
      <div
        class="flex justify-center items-center flex-grow-0 flex-shrink-0 w-[250px] h-[51px] relative overflow-hidden gap-2.5 px-2.5 py-4 rounded border border-[#1ba494]"
      >
