...
//https://blog.naver.com/karisma70kr/222829165426
  ...
  function openWinPop( uri, width, height ) { // eslint-disable-line no-unused-vars
  ...
  // 윈도우 팝업 닫기 
  function closeWinPop(){ // eslint-disable-line no-unused-vars
  ...
  function evtClose() { // eslint-disable-line no-unused-vars
  ...
  // function sendEvtToChild( evt ){ // eslint-disable-line no-unused-vars
