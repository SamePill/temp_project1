  ...
  >
    <div class="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 gap-10 pt-5">
      ...
      <div class="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 relative gap-5">
        ...
        <div
          class="flex justify-start items-center flex-grow-0 flex-shrink-0 w-[1060px] relative gap-[140px]"
        >
...
<script setup>
//import SubHeaderApplied from '@/components/layoutComponents/SubHeaderApplied.vue'
