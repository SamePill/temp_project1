      ...
      <div class="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 relative gap-5">
        <div class="flex justify-between items-start flex-grow-0 flex-shrink-0 w-[1060px]">
          ...
          <div class="flex justify-start items-start flex-grow-0 flex-shrink-0 gap-3">
            ...
            >
              <div class="flex justify-center items-center flex-grow-0 flex-shrink-0 relative gap-1">
                <p class="flex-grow-0 flex-shrink-0 text-sm text-left text-[#191919]">최신순</p>
                <svg
                  width="16"
                  height="17"
                  viewBox="0 0 16 17"
        ...
        <div class="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 gap-3">
          ...
          >
            <p
              class="flex-grow-0 flex-shrink-0 w-[60px] text-sm font-medium text-left text-[#191919]"
            >
              선정대기
            </p>
            <p class="flex-grow-0 flex-shrink-0 w-[100px] text-sm text-left text-[#191919]">
          ...
          >
            ...
            <p class="flex-grow-0 flex-shrink-0 w-[70px] text-sm text-left text-[#191919]">김큐밋</p>
            <p class="flex-grow-0 flex-shrink-0 w-[77px] text-sm text-left text-[#191919]">
              20년11개월
            </p>
            <p class="flex-grow-0 flex-shrink-0 w-[140px] text-sm text-left text-[#191919]">
          ...
          >
            <p
              class="flex-grow-0 flex-shrink-0 w-[60px] text-sm font-medium text-left text-[#dc0b56]"
            >
              선정탈락
            </p>
            <p class="flex-grow-0 flex-shrink-0 w-[100px] text-sm text-left text-[#191919]">티젠</p>
            <p class="flex-grow-0 flex-shrink-0 w-[70px] text-sm text-left text-[#191919]">최큐밋</p>
            <p class="flex-grow-0 flex-shrink-0 w-[77px] text-sm text-left text-[#191919]">
              20년11개월
            </p>
            <p class="flex-grow-0 flex-shrink-0 w-[140px] text-sm text-left text-[#191919]">
