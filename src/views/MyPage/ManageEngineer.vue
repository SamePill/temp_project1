  ...
  <div class="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 relative gap-5">
    <div class="flex justify-between items-end self-stretch flex-grow-0 flex-shrink-0 relative">
      ...
      <div class="flex justify-start items-start flex-grow-0 flex-shrink-0 relative gap-[30px]">
        <p class="flex-grow-0 flex-shrink-0 text-sm text-left text-[#777]">기업이름 : 리드워크</p>
        ...
        <p class="flex-grow-0 flex-shrink-0 text-sm text-left text-[#777]">완료된 프로젝트 : 2개</p>
      </div>
    </div>
      ...
      <div class="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 gap-5">
        ...
        >
          <div class="flex justify-start items-center flex-grow-0 flex-shrink-0 relative gap-10">
            ...
            <p class="flex-grow-0 flex-shrink-0 w-[30px] text-sm text-left text-[#191919]">휴직</p>
          ...
          <div class="flex justify-start items-center flex-grow-0 flex-shrink-0 relative gap-10">
            ...
            <p class="flex-grow-0 flex-shrink-0 w-[77px] text-sm text-left text-[#191919]">없음</p>
            <p class="flex-grow-0 flex-shrink-0 w-[99px] text-sm text-left text-[#191919]">
              인천 미추홀구
            </p>
            <p class="flex-grow-0 flex-shrink-0 w-[52px] text-sm text-left text-[#1ba494]">
          ...
          <div class="flex justify-start items-center flex-grow-0 flex-shrink-0 relative gap-10">
            ...
            <p class="flex-grow-0 flex-shrink-0 w-[30px] text-sm text-left text-[#191919]">퇴직</p>
            <p class="flex-grow-0 flex-shrink-0 w-[100px] text-sm text-left text-[#191919]">
              서울사이버대학교
            </p>
            <p class="flex-grow-0 flex-shrink-0 w-[77px] text-sm text-left text-[#191919]">
            ...
            <p class="flex-grow-0 flex-shrink-0 w-[52px] text-sm text-left text-[#191919]">
              투입 완료
            </p>
          </div>
          <div class="flex justify-start items-center flex-grow-0 flex-shrink-0 relative gap-10">
