<template>
  <div>
    <div
      class="pt-[110px] flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 gap-10"
    >
      <div
    ...
    >
      ...
      >
        <div
          class="flex justify-start items-center flex-grow-0 flex-shrink-0 relative gap-5"
        >
          <button
