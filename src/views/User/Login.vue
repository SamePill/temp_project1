<template>
    <div>
        <div class="pt-[110px] flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 gap-10">
            ...
            <div class="flex flex-col justify-center items-start flex-grow-0 flex-shrink-0 w-[430px] relative gap-5">
                <p class="flex-grow-0 flex-shrink-0 text-3xl font-bold text-left text-[#191919]">
                로고 영역
                </p>
                <p class="flex-grow-0 flex-shrink-0 text-xl font-medium text-left text-[#191919]">
                <span class="flex-grow-0 flex-shrink-0 text-xl font-medium text-left text-[#191919]">클라이언트와 </span><br/>
                    <span class="flex-grow-0 flex-shrink-0 text-xl font-medium text-left text-[#191919]">QA 파트너스의 만남</span>
                </p>
            </div>
